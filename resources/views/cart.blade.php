...
<body class="bg-gray-100 min-h-screen flex flex-col">
    ...
    <div class="max-w-7xl mx-auto px-6 py-10">
        <h1 class="text-xl font-semibold text-gray-800 mb-4">Your E-commerce Cart</h1>
        <p class="text-gray-600">Review your selected items and proceed to checkout.</p>
    </div>
            ...
            <div class="bg-white rounded-xl shadow hover:shadow-lg overflow-hidden transition">
                ...
                <div class="text-center py-3">
                    <div class="flex items-center justify-center gap-3">
                        <button class="w-8 h-8 bg-red-500 hover:bg-red-600 text-white rounded-full flex items-center justify-center font-bold transition">−</button>
                        <input type="number" value="1" min="0" class="w-16 text-center py-1 font-semibold" readonly>
                    </div>
                </div>
            </div>
